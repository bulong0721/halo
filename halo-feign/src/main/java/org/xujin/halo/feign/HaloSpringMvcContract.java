 ...
 */
public class HaloSpringMvcContract extends HaloBaseContract implements ResourceLoaderAware {
    private static final Logger LOGGER = LoggerFactory.getLogger(HaloSpringMvcContract.class);
    ...
    protected boolean processAnnotationsOnParameter(MethodMetadata data,
        ...
        AnnotatedParameterProcessor.AnnotatedParameterContext context = new HaloSpringMvcContract.SimpleAnnotatedParameterContext(
                data, paramIndex);
