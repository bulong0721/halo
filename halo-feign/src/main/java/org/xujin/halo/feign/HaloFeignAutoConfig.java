...
public class HaloFeignAutoConfig {
    ...
    @Bean
    public HaloRequestInterceptor feignRequestInterceptor() {
        return new HaloRequestInterceptor();
    }

    @Bean
    public HaloSpringMvcContract feignSpringMvcContract(@Autowired(required = false) List<AnnotatedParameterProcessor> parameterProcessors,
                                                        ConversionService conversionService) {
        if (null == parameterProcessors) {
            parameterProcessors = new ArrayList<>();
        }
        return new HaloSpringMvcContract(parameterProcessors, conversionService);
    }
